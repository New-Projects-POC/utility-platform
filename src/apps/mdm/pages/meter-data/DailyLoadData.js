...
// ── Constants ─────────────────────────────────────────────────────────────────
const LP_API           = '/api/mdm/meter-data/getUiDailyLoadProfileData/query';
const PAGE_SIZE        = 10;
        ...
        <div className="card">
          ...
          {loading && (
            <div style={{ padding: '4rem', textAlign: 'center', color: 'var(--text3)' }}>
              ...
              <div style={{ fontSize: 12 }}>Fetching load profile data…</div>
            </div>
          )}
